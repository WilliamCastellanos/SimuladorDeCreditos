...
namespace ManejoClientesArkade.Controllers
{
    ...
    {
        private readonly ManejoLoginArkadeContext _context;

        public LoginsController(ManejoLoginArkadeContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Login>> PostLogin(Login login)
        {
            ...
            return CreatedAtAction("GetLogin", new { id = login.nickName }, login);
        }
        ...
        {
            return _context.Login.Any(e => e.nickName == id);
        }
    }
}
